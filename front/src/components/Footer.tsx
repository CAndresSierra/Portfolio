  ...
  return (
    <div className="container flex flex-col h-full mt-20 items-center justify-center bottom-0">
      <div className="flex flex-col gap-10 items-center py-10 border-b-[1px] dark:border-accent border-cyan-400">
        ...
        <div className="flex-col xl:flex xl:flex-row gap-20">
          <div className="flex gap-3 xl:justify-center justify-start mb-10 xl:mb-0 items-center">
            <IoMdMail className="text-cyan-400 dark:text-accent xl:text-xl" />
            <div className="flex flex-col">
              <h1 className="text-cyan-400 dark:text-accent xl:text-xl">
                Correo Electrónico
              </h1>
          ...
          <div className="flex gap-3 xl:justify-center justify-start  items-center">
            <BsFillTelephoneFill className="text-cyan-400 dark:text-accent xl:text-xl" />
            <div className="flex flex-col">
              <h1 className="text-cyan-400 dark:text-accent xl:text-xl">
                Teléfono
              </h1>
